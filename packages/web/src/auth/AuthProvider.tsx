...
import { CognitoUserPool, CognitoUser, AuthenticationDetails, type CognitoUserSession } from "amazon-cognito-identity-js";
import { CONFIG } from "../config";
import { setAuthToken, setSessionExpiredCallback, loadPersistedToken } from "../api/client";
  ...
  const login = async (email: string, password: string) => {
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      cognitoUser.authenticateUser(authDetails, {
        ...
        newPasswordRequired: () => {
          setState((s) => ({ ...s, isLoading: false, error: "Password change required. Please contact admin." }));
